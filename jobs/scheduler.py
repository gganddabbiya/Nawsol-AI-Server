...
cron_bond_hour = os.getenv("CRON_FUND_HOUR", "22")
cron_bond_minute = os.getenv("CRON_FUND_MINUTE", "45")
cron_fund_hour = os.getenv("CRON_BOND_HOUR", "22")
cron_fund_minute = os.getenv("CRON_BOND_MINUTE", "46")
